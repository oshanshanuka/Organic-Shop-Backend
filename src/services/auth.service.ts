...
const adminUser:User = {
    ...
    password: bcrypt.hashSync(
        'admin123', // In a real application, use a secure password
        10 // Salt rounds
    ),
    role: 'admin'
}
...
export const authenticateUser = (username:string,password:string)=> {
    ...
    const accessToken = jwt.sign({id:existingUser.id,username:existingUser.username,role:existingUser.role
